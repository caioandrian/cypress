...
Funcionalidade: API
    ...
    Esquema do Cenario: Criar conta para movimentação
        ...
        Então deve obter como resposta o schema "api/post_conta_movimentacao" com status <status>
    ...
    Cenario: Atualizar nome de uma conta por ID
        ...
        Então deve obter como resposta o schema "api/put_conta_movimentacao" com status 200
    ...
    Cenario: Criar nova transação em uma conta
        ...
        Então deve obter como resposta o schema "api/post_transacao" com status 201
    ...
    Cenario: Atualizar o status de uma transação por ID
        ...
        Então deve obter como resposta o schema "api/put_transacao" com status 200
    ...
    Cenario: Deletar uma transação por ID
        ...
        Então deve obter como resposta o schema "api/delete_transacao" com status 204